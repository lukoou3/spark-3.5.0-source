...
public interface SqlBaseParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code identifierClause}
	 * labeled alternative in {@link SqlBaseParser#primaryExpression}.
	 * @param ctx the parse tree
	 */
	void enterIdentifierClause(SqlBaseParser.IdentifierClauseContext ctx);
	/**
	 * Exit a parse tree produced by the {@code identifierClause}
	 * labeled alternative in {@link SqlBaseParser#primaryExpression}.
	 * @param ctx the parse tree
	 */
	void exitIdentifierClause(SqlBaseParser.IdentifierClauseContext ctx);
	/**
