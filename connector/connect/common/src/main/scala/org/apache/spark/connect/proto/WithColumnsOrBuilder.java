...
public interface WithColumnsOrBuilder extends
   ...
   */
  java.util.List<org.apache.spark.connect.proto.Expression.Alias> 
      getAliasesList();
  /**
   * <pre>
   * (Required)
   ...
   * <code>repeated .spark.connect.Expression.Alias aliases = 2;</code>
   */
  org.apache.spark.connect.proto.Expression.Alias getAliases(int index);
  /**
   * <pre>
   * (Required)
   *
   ...
   * <code>repeated .spark.connect.Expression.Alias aliases = 2;</code>
   */
  java.util.List<? extends org.apache.spark.connect.proto.Expression.AliasOrBuilder> 
   ...
   * <code>repeated .spark.connect.Expression.Alias aliases = 2;</code>
   */
  org.apache.spark.connect.proto.Expression.AliasOrBuilder getAliasesOrBuilder(
      int index);
}
