...
public interface UnpivotOrBuilder extends
   ...
   * <code>repeated .spark.connect.Expression ids = 2;</code>
   */
  org.apache.spark.connect.proto.Expression getIds(int index);
  /**
   * <pre>
   * (Required) Id columns.
   * </pre>
   ...
   * <code>repeated .spark.connect.Expression ids = 2;</code>
   */
  org.apache.spark.connect.proto.ExpressionOrBuilder getIdsOrBuilder(
      int index);
   ...
   * @return The values.
   */
  org.apache.spark.connect.proto.Unpivot.Values getValues();
  /**
   * <pre>
   * (Optional) Value columns to unpivot.
   * </pre>
   ...
   * <code>optional .spark.connect.Unpivot.Values values = 3;</code>
   */
  org.apache.spark.connect.proto.Unpivot.ValuesOrBuilder getValuesOrBuilder();
