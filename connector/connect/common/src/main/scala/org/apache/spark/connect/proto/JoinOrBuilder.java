...
public interface JoinOrBuilder extends
   ...
   * @return The left.
   */
  org.apache.spark.connect.proto.Relation getLeft();
  /**
   * <pre>
   * (Required) Left input relation for a Join.
   * </pre>
   ...
   * <code>.spark.connect.Relation left = 1;</code>
   */
  org.apache.spark.connect.proto.RelationOrBuilder getLeftOrBuilder();
   ...
   * @return The right.
   */
  org.apache.spark.connect.proto.Relation getRight();
  /**
   * <pre>
   * (Required) Right input relation for a Join.
   * </pre>
   ...
   * <code>.spark.connect.Relation right = 2;</code>
   */
  org.apache.spark.connect.proto.RelationOrBuilder getRightOrBuilder();
   ...
   */
  org.apache.spark.connect.proto.Expression getJoinCondition();
  /**
   * <pre>
   * (Optional) The join condition. Could be unset when `using_columns` is utilized.
   *
   ...
   * <code>.spark.connect.Expression join_condition = 3;</code>
   */
  org.apache.spark.connect.proto.ExpressionOrBuilder getJoinConditionOrBuilder();
   ...
   * @return The joinType.
   */
  org.apache.spark.connect.proto.Join.JoinType getJoinType();
   ...
   */
  org.apache.spark.connect.proto.Join.JoinDataType getJoinDataType();
  /**
   * <pre>
   * (Optional) Only used by joinWith. Set the left and right join data types.
   * </pre>
   ...
   * <code>optional .spark.connect.Join.JoinDataType join_data_type = 6;</code>
   */
  org.apache.spark.connect.proto.Join.JoinDataTypeOrBuilder getJoinDataTypeOrBuilder();
}
