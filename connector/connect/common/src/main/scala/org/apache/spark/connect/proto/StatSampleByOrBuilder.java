...
public interface StatSampleByOrBuilder extends
   ...
   */
  java.util.List<org.apache.spark.connect.proto.StatSampleBy.Fraction> 
      getFractionsList();
  /**
   * <pre>
   * (Required) Sampling fraction for each stratum.
   ...
   * <code>repeated .spark.connect.StatSampleBy.Fraction fractions = 3;</code>
   */
  org.apache.spark.connect.proto.StatSampleBy.Fraction getFractions(int index);
  /**
   * <pre>
   * (Required) Sampling fraction for each stratum.
   *
   ...
   * <code>repeated .spark.connect.StatSampleBy.Fraction fractions = 3;</code>
   */
  java.util.List<? extends org.apache.spark.connect.proto.StatSampleBy.FractionOrBuilder> 
   ...
   * <code>repeated .spark.connect.StatSampleBy.Fraction fractions = 3;</code>
   */
  org.apache.spark.connect.proto.StatSampleBy.FractionOrBuilder getFractionsOrBuilder(
      int index);
